        ...
        <div>
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                  ...
                  <li class="page-item"><a class="page-link" href="/Tesis-Asistencias/?condi=1">Promedio Notas</a></li>
                  <li class="page-item"><a class="page-link" href="/Tesis-Asistencias/?condi=1">Porsentajes Asistencias</a></li>
                  <li class="page-item"><a class="page-link" href="/Tesis-Asistencias/?condi=1">TPs Entregados</a></li>
